...
public class SPROpsV2 {
    ...
    public static BigDecimal[][] getSignalMatrix(BigDecimal[][] matrix, int[] itm) {
        ...
        /**
         * 2023-03-15 - @Matheus_Pontes
         * E como fica quando se tem uma porta com mais de uma saída???
         */
    ...
    public static BigDecimal getSPRReliabilityRoundingMode (ProbCircuit pCircuit, int scale) {
