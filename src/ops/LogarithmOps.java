 ...
 * @author matheus
 */
public class LogarithmOps {
    
     /**
     * Compute the natural logarithm of x to a given scale, x > 0.
     */
    public static BigDecimal lnBig(BigDecimal x, int scale)
    {
        // Check that x > 0.
        if (x.signum() <= 0) {
        ...
        // Compute magnitude*ln(x^(1/magnitude)).
            ...
            // ln(x^(1/magnitude))
            BigDecimal lnRoot = lnBigNewton(root, scale);
     ...
     */
    private static BigDecimal lnBigNewton(BigDecimal x, int scale)
    {
        int        sp1 = scale + 1;
        BigDecimal n   = x;
        BigDecimal term;
