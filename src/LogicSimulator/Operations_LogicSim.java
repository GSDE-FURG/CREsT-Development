 ...
 */
 public class Operations_LogicSim {
    ...
    public ArrayList <Signal> calcAllSignals(){
     ...
     public void MulltiThreading_Simulator_ramdomInputs_MonteCarlo_SingleFault(String library, String CircuitFile, int testNumber, int interaction, int id) throws IOException, Exception{
     ...
     public void MulltiThreading_Simulator_ramdomInputs_MonteCarlo_MultipleFault(String library, String CircuitFile, int testNumber, int interaction, int id, int multipleFaults) throws IOException, Exception{
                ...
                for (int i = 0; i < this.thread; i++) { //Loop of simulations
                                ...
                                for (int j = start; j < end ; j++) {
                                        ...
                                        temp.setfaultSignalsList(faultSignals);
