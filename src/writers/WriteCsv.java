...
public class WriteCsv {
    ...
    public void writeCSVCompleteTh(String filename, String circuitName, ArrayList <Signal> inputSignals,  ArrayList <Signal> outputSignals,  ArrayList <Signal> all_signals, String Head, ArrayList <ArrayList<String>> inputArrayList, ArrayList <ArrayList<String>> outputFreeFault , ArrayList <ArrayList<String>> outputFault, ArrayList <ArrayList<String>> signalFault, ArrayList <ArrayList<String>>signalFaultBitFlip, int propagated_faults) throws IOException {
    ...
    @SuppressWarnings("empty-statement")
     public void writeCSVTh(String filename, String circuitName, ArrayList <Signal> inputSignals,  ArrayList <Signal> outputSignals,  ArrayList <Signal> all_signals, String Head, ArrayList <ArrayList<String>> inputArrayList, ArrayList <ArrayList<String>> output) throws IOException {
